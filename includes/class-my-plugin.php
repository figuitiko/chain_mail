 ...
 */
  ...
  namespace My_Plugin;
  use chain_mail\Loader as Loader;
 ...
 class My_plugin {
    ...
    protected $version;
    protected $my_plugin_url;
    protected $my_path;

    public function __construct() {

        $this->plugin_name = 'My-chain-mail';
        $this->version = '0.0.1';
        
        $this->my_plugin_url = plugin_dir_url( __FILE__ ) ;
    ...
    private function load_dependencies() {
        ...
        require_once ($this->my_path. '/class-my-loader.php');
       ...
       // require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-my-booking-widget.php';
        ...
        $this->loader = new loader\My_Loader();
